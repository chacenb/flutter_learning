...
class _ChaceComItemsState extends State<ChaceComItems> {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
        ...
        itemBuilder: (context, i) {
          ...
          // return chacecomListTileItem(i);

          /// Or return a Custom component ()
          return ChaceComItemLayout(
  ...
  Container chacecomListTileItem(int i) {
    return Container(
  ...
  Container chacecomCustomItem(int i) {
    return Container(
      ...
      child: Row(
        children: [
          Expanded(flex: 1, child: CircleAvatar(child: Text(chacecomItemsList[i].label[0]))
          ...
          Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(chacecomItemsList[i].description, style: const TextStyle(fontWeight: FontWeight.w400, fontStyle: FontStyle.italic, color: Colors.black38, fontSize: 11))
                ],
              )),
